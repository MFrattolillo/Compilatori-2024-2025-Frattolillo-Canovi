...
define dso_local void @Identity(i32 noundef %0) #0 {
  ...
  %4 = mul nsw i32 %0, 1
  %5 = mul nsw i32 1, %0
  %6 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %2)
  %7 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %3)
  %8 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %4)
  %9 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %5)
  ret void
}
